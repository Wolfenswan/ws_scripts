...
//   movelocation: can either be a marker, an object, a valid pos array [x,y,z] or "". When "" the group will execute their orders at their spawn
// 3.Mode (string):
...
ws_fnc_createGroup = {
	...
	switch (_mode) do {	
		...
		case "patrol": {
			...
			_wp setWaypointStatements ["true", "[group this,getPos this,250] call BIS_fnc_taskPatrol;"];
			_grp setCurrentWaypoint _wp;
		};
	};
